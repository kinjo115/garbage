...
@section('meta')
    <title>カテゴリー編集 | 名古屋市ゴミ収集サイト</title>
@endsection
        ...
        <div class="admin-card">
            <div class="admin-card-header">
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <h3 class="admin-card-title">カテゴリー情報を編集</h3>
                ...
                <form method="POST" action="{{ route('admin.item-categories.update', $category->id) }}">
                    ...
                    <div style="max-width: 600px;">
                        <div style="margin-bottom: 15px;">
                            ...
                            <input type="text" name="name" value="{{ old('name', $category->name) }}" required style="width: 100%; padding: 8px 12px; border: 1px solid #ddd; border-radius: 4px; font-size: 14px;">
                            @error('name')
                        ...
                        <div style="margin-bottom: 15px;">
                            ...
                            <input type="number" name="sort" value="{{ old('sort', $category->sort) }}" min="0" style="width: 100%; padding: 8px 12px; border: 1px solid #ddd; border-radius: 4px; font-size: 14px;">
                            @error('sort')
                                <span style="color: #ED4141; font-size: 12px;">{{ $message }}</span>
                            @enderror
                        </div>
