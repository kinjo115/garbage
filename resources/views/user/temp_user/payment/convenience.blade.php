...
@section('meta')
    ...
    <meta property="og:url" content="{{ route('guest.payment.convenience', ['token' => $tempUser->token]) }}">
        ...
        <div class="c-container">
            ...
            <div class="page-content form-content">
                ...
                <div class="form-submit mt-6">
                    <a href="{{ route('guest.payment.index', ['token' => $tempUser->token]) }}" class="c-button btn-416FED">支払い方法選択に戻る</a>
                </div>
            </div>
        </div>
    </div>
